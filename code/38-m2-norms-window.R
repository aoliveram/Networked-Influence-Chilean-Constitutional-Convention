# =============================================================================
# 38-m2-norms-window.R  (comentario del autor 2026-07-23, punto 2)
...
#   (b) FE con theta de RÉGIMEN HOMOGÉNEO era-2/3 (code/28-dynirt-regimes.R) — el insumo
