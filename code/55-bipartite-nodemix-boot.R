# =============================================================================
# 55-bipartite-nodemix-boot.R  (E4, comentario del autor post-PoliCICS:
...
# del clogit por bloque, code/44): Derecha (VC) | CentroIzq (LA+INN) |
...
cat("=== 55-bipartite-nodemix-boot.R (E4: mezcla por bloque politico, B = 500) ===\n")
