# =============================================================================
# 32-m2-measurement-propagation.R  (comentario del autor 2026-07-21, punto 7)
...
# paramétrico del dynIRT, code/29-dynirt-param-bootstrap.R) tiene mediana 0.14, 3.6 veces el movimiento
...
cat("=== 32-m2-measurement-propagation.R ===\n")
...
# ---------- 1. réplicas theta* (idéntico a code/29-dynirt-param-bootstrap.R, semillas 1001..1050) -----
