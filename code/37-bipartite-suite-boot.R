# =============================================================================
# 37-bipartite-suite-boot.R  (ETAPA 2; espec S3 2026-07-23: toda variable
# continua entra SOLO en su forma continua — fuera quintil theta1, quintil
# edad y nivel-educativo categóricos; entra theta2 (W-NOMINATE primer mes,
# como en el clogit). Binarias (abogado/experiencia/género) y categóricas
# genuinas (lista, distrito) siguen como nodematch.
# MPLE + ERRORES ESTÁNDAR POR BOOTSTRAP
...
cat("=== 37-bipartite-suite-boot.R (ETAPA 2: suite x7, S2, B = 500) ===\n")
