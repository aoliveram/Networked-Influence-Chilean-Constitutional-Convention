# =============================================================================
# 35-sdm-impacts.R  (IV-P.4 puntos 1-3, aprobados por el autor 2026-07-21)
...
# Modelo: el "SDM + dist_pivot" de la Tabla 13 (mismos datos que code/14-sdm-pivot.R).
#
# Outputs: results/tables/M3_sdm_impacts_exact.csv (+ consola)
# =============================================================================

cat("=== 35-sdm-impacts.R ===\n")
