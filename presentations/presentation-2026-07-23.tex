...
\begin{itemize}
  \item Utilidad latente de firmar; lo que se estima es la \emphr{probabilidad condicional} de la coalición observada, dado su tamaño — el atractivo del texto ($\alpha_a$) \emphr{se cancela}:
\end{itemize}
...
\begin{itemize}
  ...
  \item Aprendizaje 2 — \emphr{la herramienta importa}: la unidad real (persona $\times$ documento) cambia magnitudes y agrega hechos nuevos — la lista se achica, y las duplas no se reciclan.
\end{itemize}
\end{frame}
