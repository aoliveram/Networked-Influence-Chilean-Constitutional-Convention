...
\author{Aníbal Olivera M. \& Jorge Fábrega F.}
\date{}
...
\begin{itemize}
  ...
  \vspace{0.25cm}
  \item Las \emphr{posiciones}: con exposición con decaimiento hay indicios de influencia, pero exige análisis \emph{aún en curso}: $\theta$ re-estimado solo con la era de normas, sub-ventanas.
  \vspace{0.25cm}
