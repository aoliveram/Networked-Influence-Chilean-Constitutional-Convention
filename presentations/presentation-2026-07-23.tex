...
% ================================================================ ACTO I
\sectionslide{Acto I}{¿Podíamos predecir la red de colaboración?}
...
\midrule
\multicolumn{8}{l}{Extensión continua (\texttt{b2covrange}): rango de $\theta_1$ por documento $\in [-9.7, -3.3]$, $p<.001$ en las 7 — los textos \emphr{evitan} dispersión ideológica.}\\
\bottomrule
\end{tabular}
\end{center}
\vspace{0.1cm}
...
% ================================================================ ACTO II
\sectionslide{Acto II}{¿Qué compra el capital relacional?}
