...
\end{center}
\vspace{0.05cm}
\nota{Variables continuas solo en forma continua (rango por documento); EE por bootstrap de iniciativas (B = 500). La ideología opera en ambas dimensiones; la lista se achica al condicionar en estructura; las \emph{parejas no se sobre-usan} (gwdsp $<$ 0 en las 7).}
\end{frame}
