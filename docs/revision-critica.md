...
**Piloto de factibilidad ejecutado sobre los datos reales (2026-07-14; `code/26-rhem-pilot.R`, escalera mínimo→complejo; `results/tables/RHEM_pilot_timing.csv`).** Con los 487 hipereventos $\leq 16$ (D8), orden temporal provisorio por prefijo ICC (483/487; el run real debe verificar fechas oficiales de ingreso), y la capa fina ya escrita (muestreador de coaliciones control del mismo tamaño + exógenas de composición):
