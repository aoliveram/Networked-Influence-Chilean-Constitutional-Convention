...
**Tabla 8 — ERGM bipartito por comisión (siete modelos; especificación extendida a paridad con el logit condicional, con las variables continuas también en su versión de rango por documento; estimación MPLE).**
...
| Rango de $\theta_1$ por documento | $-7.55^{***}$ | $-7.93^{***}$ | $-9.71^{***}$ | $-8.34^{***}$ | $-5.01^{***}$ | $-6.74^{***}$ | $-3.28^{***}$ |
